...
const toolComponents: Record<string, React.ComponentType> = {
  ...
  "ffmpeg-builder": dynamic(() => import("@/components/tools/ffmpeg-builder").then(mod => mod.FfmpegBuilderTool)),
  "imagemagick-builder": dynamic(() => import("@/components/tools/imagemagick-builder").then(mod => mod.ImagemagickBuilderTool)),
  "gifsicle-builder": dynamic(() => import("@/components/tools/gifsicle-builder").then(mod => mod.GifsicleBuilderTool)),
  ...
  dithering: dynamic(() => import("@/components/tools/dithering").then(mod => mod.DitheringTool)),
  dots: dynamic(() => import("@/components/tools/dots").then(mod => mod.DotsTool)),
  ascii: dynamic(() => import("@/components/tools/ascii").then(mod => mod.AsciiTool)),
  recolor: dynamic(() => import("@/components/tools/recolor").then(mod => mod.RecolorTool)),
  edge: dynamic(() => import("@/components/tools/edge").then(mod => mod.EdgeTool)),
  stippling: dynamic(() => import("@/components/tools/stippling").then(mod => mod.StipplingTool)),
  scatter: dynamic(() => import("@/components/tools/scatter").then(mod => mod.ScatterTool)),
  bevel: dynamic(() => import("@/components/tools/bevel").then(mod => mod.BevelTool)),
  crt: dynamic(() => import("@/components/tools/crt").then(mod => mod.CrtTool)),
  patterns: dynamic(() => import("@/components/tools/patterns").then(mod => mod.PatternsTool)),
  distort: dynamic(() => import("@/components/tools/distort").then(mod => mod.DistortTool)),
  displace: dynamic(() => import("@/components/tools/displace").then(mod => mod.DisplaceTool)),
